...
class MlflowMonitor(Monitor):
    ...
    Args:
        uri (`Optional[str]`): The tracking server URI. If not provided, the default is `
    ...
    def __init__(
        ...
        mlflow.set_tracking_uri(config.monitor.monitor_args.get("uri", ""))
...
class SwanlabMonitor(Monitor):
    ...
    This monitor integrates with SwanLab () to track experiments.
