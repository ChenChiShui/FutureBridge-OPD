...
class SciWorldWorkflow(MultiTurnWorkflow):
    ...
    async def run_async(self) -> List[Experience]:
        ...
        try:
            ...
            error_message = f"Error importing SciWorldTWEnv {str(e)}. Please make sure you have installed the sciworld package successfully, following the instructions in "
