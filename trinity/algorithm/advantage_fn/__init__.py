...
ADVANTAGE_FN: Registry = Registry(
    ...
    default_mapping={
        ...
        "cross_tokenizer_opd": "trinity.algorithm.advantage_fn.cross_tokenizer_opd_advantage.CrossTokenizerOpdAdvantage",
        "jsd": "trinity.algorithm.advantage_fn.jsd_advantage.JSDAdvantage",
        "sdpo": "trinity.algorithm.advantage_fn.sdpo_advantage.SDPOAdvantage",
    },
)
