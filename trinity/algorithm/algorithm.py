...
class SDPOAlgorithm(AlgorithmType):
    """SDPO (Self-Distilled Policy Optimization) algorithm.

    SDPO computes teacher-student distillation signal in trainer-side advantage_fn,
    then optimizes with policy loss (PPO/IS style update).
    """
